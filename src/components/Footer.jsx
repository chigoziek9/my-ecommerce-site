const Footer = () => {
  return (
    <>
      <footer class="w-full bg-black text-white sm:block md:block ">
        {/* first footer */}
      ...
      {/* second mobile footer */}

      <footer class="block lg:hidden w-full py-14 bg-black text-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="max-w-3xl mx-auto">
            <a
              href="https://pagedone.io/"
              class="flex justify-center text-white text-2xl font-bold"
            >
              EXCLUSIVE
            </a>

            <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-500">
              <li>
